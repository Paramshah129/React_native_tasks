...
const ChatBotScreen=() => {
  ...
  const API_KEY ='AIzaSyADKY396K40ofK4ZqB8l-20H7ADgAWECjw';
  ...
  const getGeminiResponse=async(userMessage) => {
    try{
      const models = ['gemini-2.5-flash','gemini-2.0-flash','gemini-2.5-pro','gemini-flash-latest','gemini-2.0-flash-lite'];
      ...
      >
        ...
        {isLoading && (
          <View style={styles.loadingContainer}>
            <ActivityIndicator size="small" color="#1C6E1C" />
      ...
      <View style={styles.inputContainer}>
        ...
        >
          <Ionicons
            name="send"
            size={24}
            color={inputText.trim()?'#1C6E1C':'#CCC'}
          />
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
